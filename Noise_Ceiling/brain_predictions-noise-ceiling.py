...
import os
from Brain_preditictions import utils1
...
if __name__ == "__main__":
    ...
    for source_subject in source_subjects:
        ...
        np.save(os.path.join(save_dir, "predict_{}_with_{}_{}pcs.npy".format(target_subject, source_subject,
                                                                             sourcedata_train.shape[1])), corrs_t)
